...
void send_oneM2M::ae_create(string AE_NAME)
{
	...
	json_data[U("m2m:ae")][U("poa")][0] =json::value::string(utility::conversions::to_string_t(ae_poa_URL));
    //json_data[U("m2m:ae")][U("poa")][0] =json::value::string(utility::conversions::to_string_t("http://192.168.178:10053"));
...
void send_oneM2M::sub_create(string originator_string, int num, ...)
{
    try
    {
	    ...
	    if(nu_URL == "")
	    {
		    cout << "ERROR OCCURRED IN send_oneM2M::sub_create. nu_URL is NULL" << endl;
	        exit(0);
	    }
	    ...
	    else
	    {
		    ...
		    json_data[U("m2m:sub")][U("nu")][0] = json::value::string(utility::conversions::to_string_t("tinyIoT/SejongAI"));
		    //json_data[U("m2m:sub")][U("nu")][0] = json::value::string(utility::conversions::to_string_t(nu_URL));
