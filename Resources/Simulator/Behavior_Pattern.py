...
def write_to_file(Elevator_System, Elevator, filepath):
...
def run():
    ...
    # PHASE 3: LOG Analyze
        if flag_analyze_log:
            ...
            if log_instance_data.inout == True and 12 in log_instance_data.in_current_buttons:
                print("ASDASDSAD")
            ...
            if inout: # If Log is IN Log
                ...
                if number_of_elevators >= 2:
                    ...
                    elif opcode == 21 or opcode == 22 or opcode == 23: # If Elevator is Moving
                        Single_Elevator.run(Elevator_System, elevator, log_instance)
