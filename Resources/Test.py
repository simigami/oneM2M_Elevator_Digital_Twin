...
class Lps25hsensor:
    ...
    def setup(self):
        try:
            ...
            self.bus.write_i2c_block_data(self.address, 0x2e, [0xdf])
    ...
    def read_pressure(self):
        try:
            self.bus.write_i2c_block_data(self.address, 0x20, [0xa4])
        except OSError as e:
            print(e)
...
if __name__ == '__main__':
    alt_arr = []
    for i in range(20):
        timestamp, total_alt, total_temp = return_average_alt(5)   # 5 is Optimisitc Because [Get_Pressure function ms] * num = 1000ms(1s)
